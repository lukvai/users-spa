...
import { User, UserGender, UserStatus } from '../../interfaces/User'
...
const UsersInfoEditForm = ({ user }: UsersInfoEditFormProps) => {
  const { register, handleSubmit, setValue } = useForm({
    resolver: zodResolver(schema),
    defaultValues: user
  })
  const [isChecked, setIsChecked] = useState<boolean>(user.status === UserStatus.active)
